...
Networking tools and command I always forget on my daily and have to google them a hundred time will now be part of this Document
...
```bash
nmap -sV --script http-malware-host 192.168.1.193
```
